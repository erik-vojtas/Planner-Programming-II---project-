...
# insert into activity values ('02.05.2020', '10:00', 'go shopping');
# insert into activity values ('12.31.2020', '10:00', 'running');
# insert into quote (quote, author) values ('Do not dwell in the past, do not dream of the future, concentrate the mind on the present moment.', 'Buddha');
# insert into quote (quote, author) values ('Sometimes life hits you in the head with a brick. Do not lose faith.', 'Steve Jobs');
# insert into quote (quote, author) values ('As a well-spent day brings happy sleep, so a life well spent brings happy death.', 'Leonardo da Vinci');
